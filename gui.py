...
class Application(ttk.Frame):
    ...
    def settings_window(self):
        ...
        self.auto_login_toggle = ttk.Checkbutton(self.settings_win,text=
        "Auto-login",variable=self.check_var,
...
#####  ^End of windows^  #######
    ...
    def create_user(self):
        ...
        if self.name_entry.get()[0].isnumeric():
            messagebox.askokcancel(message="Username must start with a letter.")
            return
    ...
    def started_script(self):
        ...
        self.home_win.title("{tab} Peek In (Running)".format(tab=CRNT_USER))
